...
official-study boundary, starts on by default, and uses blue for the official
map, dark purple for the experimental result, and orange where both mark the
same place. Phones also show a compact color key over the map. Specialist
